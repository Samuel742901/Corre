...
var grupodeobstaculos, obstaculo1, obstaculo2, obstaculo3, obstaculo4, obstaculo5, obstaculo6,obistaculo7,obistaculo8,obistaculo9;
...
function preload(){
  ...
  obistaculo7 = loadImage("trex_collided.png");
  obistaculo8 = loadImage("trex1.png");
  obistaculo9 = loadImage("trex2.png");
  ...
  if(frameCount % 60 === 0) {
    ...
    switch(rand) {
      ...
      case 6: obstaculo.addImage(obstaculo6);
              break;
      case 7: obstaculo.addImage(obistaculo7);  
              break;  
      case 8: obstaculo.addImage(obistaculo8);  
              break;  
      case 9: obstaculo.addImage(obistaculo9);  
              break;          
      default: break;
    }
